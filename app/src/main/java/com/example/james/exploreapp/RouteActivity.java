...
public class RouteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (routeType) {
            ...
            case "random":
                ...
                break;
            case "closest":
                new ClosestRouteTask().execute(url);
                break;
            case "best rated":
    ...
    private class RandomRouteTask extends AsyncTask<String, String, String> {
    ...
    private class ClosestRouteTask extends AsyncTask<String, String, String> {
    ...
    private class BestRatedRouteTask extends AsyncTask<String, String, String> {
